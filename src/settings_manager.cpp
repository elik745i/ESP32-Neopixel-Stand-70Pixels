...
SettingsBundle SettingsManager::defaults() const {
    ...
    settings.light.primaryColor = "#ffffff";
    settings.light.secondaryColor = "#000000";
    settings.light.tertiaryColor = "#ff7b00";
...
SettingsBundle SettingsManager::load() {
    ...
    settings.light.primaryColor = readString("light_c1", settings.light.primaryColor);
    settings.light.secondaryColor = readString("light_c2", settings.light.secondaryColor);
    settings.light.tertiaryColor = readString("light_c3", settings.light.tertiaryColor);
...
bool SettingsManager::save(const SettingsBundle& settings) {
    ...
    changed |= writeStringIfChanged("light_c1", sanitized.light.primaryColor);
    changed |= writeStringIfChanged("light_c2", sanitized.light.secondaryColor);
    changed |= writeStringIfChanged("light_c3", sanitized.light.tertiaryColor);
...
void SettingsManager::toJson(const SettingsBundle& settings, JsonObject root) const {
    ...
    light["primaryColor"] = settings.light.primaryColor;
    light["secondaryColor"] = settings.light.secondaryColor;
    light["tertiaryColor"] = settings.light.tertiaryColor;
